...
# Private Subnets for Internal Resources (e.g., worker nodes)
...
# Public Subnets for Internet-Accessible Resources (e.g., NAT Gateway, ALBs)
...
# Public Route Table (routes outbound traffic via Internet Gateway)
...
# Private Route Tables (each private subnet gets its own with NAT route)
